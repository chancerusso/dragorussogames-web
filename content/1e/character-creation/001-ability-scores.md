...
Ability scores describe the raw material of your character before you choose race, class, alignment, wealth, and equipment.

They answer the first big question of character creation:
...
- Strength affects physical force, melee pressure, carrying capacity, and feats such as forcing doors.
- Dexterity affects surprise, missile attacks, and defensive adjustment.
- Constitution affects hit points and survival checks tied to resurrection or major magical transformation.
- Intelligence affects additional languages and matters most to magic users and illusionists.
- Wisdom affects mental resilience and matters most to clerics and druids.
- Charisma affects henchmen, loyalty, morale, and reaction rolls.

Term notes:

- Henchmen are NPC followers who accompany adventurers.
- Morale means whether creatures continue fighting or flee.
- A reaction roll determines a creature's initial attitude.
- Surprise means whether one side acts before the other.
- Defensive adjustment affects how difficult a character is to affect or strike.

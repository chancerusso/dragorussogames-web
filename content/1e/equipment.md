...
| Weapon | Damage vs S/M | Damage vs L | Encumbrance | Cost |
| --- | ---: | ---: | ---: | ---: |
...
| Weapon | Damage vs S/M | Damage vs L | Rate | Range Increment | Encumbrance | Cost |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
...
After buying equipment, total carried weight and compare it to **[Equipment & Encumbrance](/1e/how-to-play/equipment-encumbrance/)**. Armour can limit maximum movement even when total carried weight is low.

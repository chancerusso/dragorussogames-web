...
export const racePresentation = {
  "races/kender": {
    ...
    summary: "Kender are small, fearless wanderers whose curiosity and open-handed sense of property make them unlike OSRIC halflings in play. A kender character tends to pull stories toward roads, ruins, strangers, locked things, and trouble that looks interesting rather than profitable.",
    ...
    relationships: [{ label: "OSRIC Thief", href: "/1e/classes/thief/" }, { label: "OSRIC Ranger", href: "/1e/classes/ranger/" }],
  },
  "races/gnomes": {
    ...
    relationships: [{ label: "OSRIC Gnome", href: "/1e/races/gnome/" }, { label: "Tinker Class", href: "/portal/dragonlance/classes/tinkers" }],
  },
  ...
  "races/elves/half-elves": {
    ...
    playing: "Half-elves are strong bridge characters for parties moving between human and elven communities. Use the Krynn record here where it modifies or extends the OSRIC half-elf.",
  },
  "races/dwarves/hill": {
    parent: "Dwarf",
    osricBase: "Dwarf",
    sourcePages: "65-67; summary tables 114, 117",
    summary: "Hill dwarves are the surface-associated dwarf people represented as a Krynn extension of the OSRIC dwarf. The Neidar name belongs to this setting context rather than a separate mechanical race here.",
  ...
  "races/dwarves/mountain": {
    ...
    osricBase: "Dwarf",
    sourcePages: "65-67; summary tables 114, 117",
    summary: "Mountain dwarves represent the underground dwarf tradition in this source, with Krynn-specific ability bounds and class access layered on the OSRIC dwarf base.",
...
export const raceOverviewPages = {
  races: {
    ...
    summary: "Krynn keeps the shared OSRIC rules engine, but several peoples have Dragonlance-specific ability ranges, class access, movement, languages, and special rules. Those setting records override OSRIC only where Dragonlance Adventures explicitly says so.",
    notice: "Humans use the standard OSRIC Human rules and are linked here rather than duplicated as a Dragolance race.",
    links: [
      { label: "OSRIC Human", href: "/1e/races/human/" },
      { label: "OSRIC Races", href: "/1e/races/" },
      { label: "OSRIC Ability Scores", href: "/1e/character-creation/001-ability-scores/" },
      { label: "OSRIC Class Rules", href: "/1e/classes/" },
    ],
    cards: [
  ...
  "races/elves": {
    ...
    cards: [
      ...
      { label: "Half-Elves", path: "races/elves/half-elves", copy: "Krynn-specific half-elf record extending OSRIC half-elf." },
    ],
  },
  ...
  "races/dwarves": {
    ...
    notice: "Hill and mountain dwarves extend the OSRIC dwarf. Gully dwarves are Aghar and retain their unusual source restrictions.",
    cards: [
...
export const sourceBadges = {
  ...
  core: { type: "Canonical Core Rules", label: "OSRIC" },
  mixed: { type: "Mixed Source", label: "OSRIC + Dragonlance Adventures + Dragolance commentary" },
};
...
export const relatedTopics = {
  ...
  "races/kender": [{ label: "OSRIC Thief", href: "/1e/classes/thief/" }, { label: "Fearlessness" }, { label: "Taunt" }],
  "races/gnomes": [{ label: "Tinkers", path: "classes/tinkers" }, { label: "OSRIC Gnome", href: "/1e/races/gnome/" }],
  "classes/knights-of-solamnia": [{ label: "OSRIC Fighter", href: "/1e/classes/fighter/" }, { label: "Knight of the Crown", path: "classes/knights-of-solamnia/crown" }, { label: "Knight of the Sword", path: "classes/knights-of-solamnia/sword" }, { label: "Knight of the Rose", path: "classes/knights-of-solamnia/rose" }],
  "classes/wizards-of-high-sorcery": [{ label: "OSRIC Magic-User", href: "/1e/classes/magic-user/" }, { label: "OSRIC Illusionist", href: "/1e/classes/illusionist/" }, { label: "Solinari", path: "gods/good/solinari" }, { label: "Lunitari", path: "gods/neutrality/lunitari" }, { label: "Nuitari", path: "gods/evil/nuitari" }],
  "classes/tinkers": [{ label: "Gnomes", path: "races/gnomes" }, { label: "Device Creation", path: "classes/tinkers/device-creation" }],
  gods: [{ label: "Holy Orders", path: "gods/holy-orders" }, { label: "OSRIC Cleric", href: "/1e/classes/cleric/" }],
  "gods/holy-orders": [{ label: "OSRIC Cleric", href: "/1e/classes/cleric/" }, { label: "Clerics of Good", path: "gods/clerics-good" }, { label: "Clerics of Neutrality", path: "gods/clerics-neutrality" }, { label: "Clerics of Evil", path: "gods/clerics-evil" }],
};
...
export const classReference = {
  classes: {
    ...
    sourceStatus: "Dragolance uses OSRIC as the foundation. This reference only presents the campaign-setting class structures that Dragonlance Adventures adds or substantially changes.",
    sections: [
      "Most standard classes remain in the OSRIC Reference.",
      "Knights of Solamnia extend martial OSRIC foundations, especially Fighter, Paladin, and Ranger context.",
      "Wizards of High Sorcery extend OSRIC Magic-User and Illusionist foundations.",
      "Holy Orders extend OSRIC Cleric foundations and are referenced under Gods.",
      "Tinkers are a unique gnome class and require DM approval.",
    ],
    links: [
      { label: "OSRIC Fighter", href: "/1e/classes/fighter/" },
      { label: "OSRIC Magic-User", href: "/1e/classes/magic-user/" },
      { label: "OSRIC Illusionist", href: "/1e/classes/illusionist/" },
      { label: "OSRIC Cleric", href: "/1e/classes/cleric/" },
      { label: "OSRIC Ranger", href: "/1e/classes/ranger/" },
      { label: "OSRIC Paladin", href: "/1e/classes/paladin/" },
      { label: "OSRIC Thief", href: "/1e/classes/thief/" },
      { label: "OSRIC Druid", href: "/1e/classes/druid/" },
    ],
  },
  "classes/knights-of-solamnia": {
    title: "Knights of Solamnia",
    badge: sourceBadges.mixed,
    sourceStatus: "Player-facing Solamnic rules use Dragonlance Adventures as the setting authority and OSRIC Fighter as the martial rules foundation.",
    sections: [
    ...
    links: [{ label: "OSRIC Fighter", href: "/1e/classes/fighter/" }, { label: "Paladine", path: "gods/good/paladine" }, { label: "Kiri-Jolith", path: "gods/good/kiri-jolith" }, { label: "Habbakuk", path: "gods/good/habbakuk" }],
  ...
  "classes/knights-of-solamnia/crown": {
    ...
    links: [{ label: "OSRIC Fighter", href: "/1e/classes/fighter/" }],
  ...
  "classes/knights-of-solamnia/sword": {
    ...
    links: [{ label: "Kiri-Jolith", path: "gods/good/kiri-jolith" }, { label: "OSRIC Cleric", href: "/1e/classes/cleric/" }],
  ...
  "classes/wizards-of-high-sorcery": {
    ...
    links: [{ label: "OSRIC Magic-User", href: "/1e/classes/magic-user/" }, { label: "OSRIC Illusionist", href: "/1e/classes/illusionist/" }],
...
export const godsReference = {
  gods: {
    ...
    sections: ["Krynn's gods are organized around Good, Neutrality, and Evil.", "The Holy Orders extend OSRIC cleric rules through deity selection, spheres, obligations, and alignment relationships.", "The gods of magic also govern the Orders of High Sorcery."],
    links: [{ label: "OSRIC Cleric", href: "/1e/classes/cleric/" }, { label: "Holy Orders of the Stars", path: "gods/holy-orders" }],
  },
  "gods/overview": null,
  "gods/holy-orders": {
    ...
    records: [holyOrders],
    links: [{ label: "OSRIC Cleric", href: "/1e/classes/cleric/" }],
  },

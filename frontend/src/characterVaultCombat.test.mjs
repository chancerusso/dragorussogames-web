...
test("OSRIC magic item catalog contains real catalog records", () => {
  ...
  assert.ok(magicItemCatalog.items.some((item) => item.name === "Hammer of Thunderbolts" && item.equipment_effects.kind === "weapon" && item.equipment_effects.attack_bonus === 3 && item.equipment_effects.damage_bonus === 3 && item.equipment_effects.damage_small_medium === "4d6"));

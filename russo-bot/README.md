...
Use `#pc-maintenance` for character creation, equipment changes, treasure updates, and between-session maintenance. Use `/show card` to display the compact read-only table card.

...
CHARACTER_RUNTIME_AUDIT: list[RuntimeAuditField] = [
    ...
    RuntimeAuditField("attack values", "canonical-derived", "canonical attack_progression / class-group fallback", "Derived at runtime; some canonical attack rows remain partial."),
    RuntimeAuditField("THAC0", "canonical-derived", "combat_runtime.thac0", "Derived at payload time; core class groups use encoded fallback bands until full attack matrices are normalized."),

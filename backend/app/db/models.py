...
class SpellsCatalog(TimestampMixin, Base):
    ...
    mechanics_by_class: Mapped[dict] = mapped_column(JSONType, default=dict, nullable=False)
    ...
    casting_time: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    saving_throw: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    school: Mapped[Optional[str]] = mapped_column(String(160), nullable=True)
    reversible: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false", nullable=False)
    description: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    rules_reference: Mapped[Optional[str]] = mapped_column(String(240), nullable=True)
    ...
    effect_verification: Mapped[str] = mapped_column(String(80), default="pending_semantic_review", server_default="pending_semantic_review", nullable=False)
    archived: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false", nullable=False)
